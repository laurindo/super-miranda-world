...
******************
  ...
  - Please take a look on the template.lua file and dont forget to always
...
function director:changeScene( params,
	...
	for i = currentStage.numChildren, 1, -1 do
		...
		------------------
		-- Insert into the CURR group if its needed
		------------------
	...
	for i = currentStage.numChildren, 1, -1 do
		...
		------------------
		-- Insert into the NEXT group if its needed
		------------------
...
function director:openPopUp( params, newPopUpScene, onClose )
	...
	------------------
	-- If is inside a popup, dont load
	------------------
...
function director:closePopUp()
	...
	------------------
	-- If no popup is loaded, dont do anything
	------------------
